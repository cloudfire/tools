...
public class CopyOfBlowfish {
	...
	public static final IvParameterSpec idCrypterIv = new IvParameterSpec(idCrypterSaltBytes, 32, 8);
    /**
     ...
     */
    public CopyOfBlowfish(String password) {
...
//            Log.error(e);
    ...
    public CopyOfBlowfish(byte[] passwd, byte[] iv){
...
//		System.out.println(IdEncrypter.idCrypterKey.getAlgorithm());
		CopyOfBlowfish blowfish = new CopyOfBlowfish(idCrypterKey.getEncoded(), idCrypterIv.getIV());
		System.out.println(blowfish.encryptString("96034041"));
//		IdEncrypter.encrypt(96034041);
	}
}
